...
def main():
    ...
    # dataset_config = "20200501.simple"
    dataset_language = "pt"
    ...
    # dataset = load_dataset(dataset_name, dataset_config, beam_runner="DirectRunner")
    print(dataset)
    dataset = dataset.map(
    ...
    dataset["train"].to_csv(
        f"data/{dataset_name}_{dataset_date}_{dataset_language}.csv",
        num_proc=6,
